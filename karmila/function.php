...
function tambah_data_pesanan() {
    ...
    foreach ($list_pesanan as $lp) {
        ...
        // Tambahkan debug output untuk melihat apa yang sedang disisipkan
        if (!mysqli_query($koneksi, "INSERT INTO pesanan VALUES ('', '$kode_pesanan', '$kode_menu', '$qty','$jenis_pesanan')")) {
    ...
    if (!mysqli_query($koneksi, "INSERT INTO transaksi SET kode_pesanan = '$kode_pesanan', nama_pelanggan = '$pelanggan', jenis_pesanan = '$jenis_pesanan', kode_menu = '$kode_menu'")) {
