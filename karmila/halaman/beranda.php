...
<div class="d-flex flex-wrap justify-content-between">
    ...
    <nav class="navbar navbar-light">
        ...
        <form action="index.php" method="GET" class="form-inline d-flex">
            ...
            <button class="btn header-orange mx-2" name="search">Search</button>
    ...
    <nav class="navbar navbar-light">
        ...
        <a class="btn header-orange fw-bold mx-2" href="tambah.php">+ Tambah Menu Masakan</a>
...
<form action="index.php" method="POST">
    <div class="d-flex">
        ...
        <select class="form-control mx-sm-2 my-2 w-auto" name="jenis_pesanan" required>
            <option value="Take Away">Take Away</option>
            <option value="Dine In">Dine In</option>
        </select>
        <button class="btn header-orange my-2 mx-2" name="pesan">Pesan</button>
    </div>
    ...
    foreach ($menu as $m) { ?>
        ...
        <div class="col-sm-4 mx-auto m-2">
            ...
            <div class="card">
                ...
                <h5 class="card-header header-gelap"><?= $m["nama"]; ?></h5>
